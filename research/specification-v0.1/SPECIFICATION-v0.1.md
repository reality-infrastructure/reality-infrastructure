...
> Status: IMMUTABLE RESEARCH ARTIFACT (v0.1 as ratified July 2026). Revisions become v0.2 in a new file.
> The reference implementation treats the copy at reference-implementation/SPEC.md as its frozen source of truth.
